...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        // 文字颜色
        [self setTitleColor:ZYColor(100, 100, 100) forState:UIControlStateNormal];
        [self setTitleColor:ZYColor(240, 37, 38) forState:UIControlStateSelected];
        self.titleLabel.font = ZYFont(14);
